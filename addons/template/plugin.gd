...
func _enter_tree():
	add_autoload_singleton("Utils", "res://addons/template/utils.gd")
	add_autoload_singleton("Transitions", "res://addons/template/transition/transition.tscn")
	add_autoload_singleton("Game", "res://addons/template/game.gd")
